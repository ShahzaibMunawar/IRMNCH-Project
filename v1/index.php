    ...
    <section class="content">
        <div class="container">
            ...
            <div class="col-md-4 ">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center">
						...
						<div class="row">
							<div class="col-md-12">
								 <h4><i class="flaticon flaticon-pregnant-woman font-30 blue-color"></i> 191,113</h4>
								<h5 >Pragnant Women Transfer</h5>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<h4><i class="flaticon flaticon-crawling-baby-silhouette font-30 blue-color"></i> 30,000</h4>
                ...
                <ul class="hide">
                    <li>
                        <h4>Total Ambulances <span class="pull-right">200</span></h4>
                    </li>
                    <li>
                        <h4>Pragnent Women Transfer <span class="pull-right">191,113</span></h4>
                    </li>
                    <li>
                        <h4>Children Transfer <span class="pull-right">30,000</span></h4>
                    </li>
                </ul>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="pop-box">
                        <h3 class="section-heading">Population</h3>
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="row">
                                        <div class="pops-box">
                                        ...
                                        <div class="pops-box">
                                            ...
                                            <div class="col-md-7 ">
                                                <div class="row">
                                                    <div class="col-md-12 ">
                                                        <dl class="chart-statistic">
                                                            <dt>Urban Population Registered with CMW</dt>
                                                            <dd>4,062,142</dd>
                                                        </dl>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="pops-box">
                                            ...
                                            <div class="col-md-7 ">
                                                <div class="row">
                                                    <div class="col-md-12 ">
                                                        <dl class="chart-statistic">
                                                            <dt>Rural Population Registered with CMW</dt>
                                                            <dd>4,062,142</dd>
                                                        </dl>
                                                    </div>
                                                </div>
                ...
                <div class="col-md-6">
                    <h3 class="section-heading">Service Points</h3>
                    <div class="stat-box">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="points-box">
                                    <div class="points-icon">
                                        <i class="flaticon blue-color flaticon-hospital-buildings"></i>
                                    </div>
                                    <h4>HF covered by LHW <span>2677</span></h4>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="points-box">
                                    ...
                                    <h4>HF Covered by CMW <span>2677</span></h4>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="points-box">
                                    <div class="points-icon">
                                        <i class="flaticon blue-color flaticon-ambulance"></i>
                                    </div>
                        ...
                        <div class="row">
							<div class="col-md-20">
								<dl class="chart-statistic small">
								  <dt><i class="fa fa-circle color-green"></i> BHV 24/7</dt>
								  <dd>1,769</dd>
								</dl>
							</div>
							<div class="col-md-20">
								<dl class="chart-statistic small">
								  <dt><i class="fa fa-circle color-green"></i> BHV+</dt>
								  <dd>850</dd>
								</dl>
							</div>
							<div class="col-md-20">
								<dl class="chart-statistic small">
								  <dt><i class="fa fa-circle color-green"></i> RHC</dt>
								  <dd>945</dd>
								</dl>
							</div>
							<div class="col-md-20">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="service-icon">
                                                <i class="flaticon flaticon-pregnant-woman"></i>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                            ...
                            <div class="col-md-3">
                                <div class="service-box">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="service-icon">
                                                <i class="flaticon flaticon-patient-in-hospital-bed"></i>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                            ...
                            <div class="col-md-3">
                                <div class="service-box">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="service-icon">
                                                <i class="flaticon flaticon-pregnant-woman-and-fetus"></i>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <h4>ANC Visits</h4>
                            ...
                            <div class="col-md-3">
                                <div class="service-box">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="service-icon">
                                                <i class="flaticon flaticon-mother-with-baby-in-arms"></i>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <h4>PNC Visits</h4>
                            ...
                            <div class="col-md-3">
                                <div class="service-box">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="service-icon">
                                                <i class="flaticon flaticon-kids-couple"></i>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <h4>SAM Cured</h4>
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel-default i-panel">
                        <div class="panel-body">
                            <ul class="list-unstyled progress-listing">
                                <li>
            ...
            <div class="row stat-boxs">
                <!--               box 1-->
                <div class="col-md-6 colour-box">
                    <h3 class="text-center">Family Planning Mathods</h3>
                    <div class="main-data">
                        <div class="stats-box">
                            <div class="stats-icon">
                                <i class="flaticon flaticon-female-and-male-silhouettes-with-a-vertical-line-in-the-middle"></i>
                            </div>
                        </div>
                ...
                <div class="col-md-6 ">
                    ...
                    <div class="main-data">
                        <div class="stats-box">
                            <div class="stats-icon">
                                <i class="flaticon flaticon-ambulance color-cyan-lighten-1"></i>
                            </div>
                        </div>
                        <div class="main-data-text">
                            <h3>17670</h3>
                ...
                <div class="col-md-6 ">
                    ...
                    <div class="main-data">
                        <div class="stats-box">
                            <div class="stats-icon">
                                <i class="flaticon flaticon-hospital-buildings"></i>
                            </div>
                        </div>
                        <div class="main-data-text">
                            <h3>17670</h3>
                ...
                <!--                box4-->
				 <div class="col-md-6 colour-box">
                    ...
                    <div class="main-data">
                        <div class="stats-box">
                            <div class="stats-icon">
                                <i class="flaticon flaticon-elementary-school"></i>
                            </div>
                        </div>
                        <div class="main-data-text">
                            <h3>17670</h3>
...
<footer class="main-footer">
        ...
        <div class="footer-bottom">
            <div class="container">
               <div class="row clearfix">
                    <div class="col-md-12 col-sm-12 col-xs-12"><div class="copyright-text">© 2017 | Privacy Policy | All rights reserved by IRMNCH & NP, Govt Of Punjab, Pakistan</div></div>
