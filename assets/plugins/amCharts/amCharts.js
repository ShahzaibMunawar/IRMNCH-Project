...
(function () {
    ...
    d.AmGraph = d.Class({
        ...
        createSerialGraph: function () {
            ...
            "step" == h && (xb = !1);
            var lb = f.getCoordinate(f.min);
            f.logarithmic && (lb = f.getCoordinate(f.minReal));
            this.minCoord = lb;
            ...
            if (!(J || "line" != h && "smoothedLine" != h && "step" != h || (1 == e.length && "step" != h && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Ra && void 0 == Ja || m))) {
                ...
                t ? (ha = q, Qa = Math.abs(Mb - Ka), ub = q, vb = Math.abs(lb - Ka), kb = tb = 0, f.reversed ? (ca = 0, jb = Ka) : (ca = Ka, jb = 0)) : (Qa = n, ha = Math.abs(Mb - Ka), vb = n, ub = Math.abs(lb - Ka), jb = ca = 0, f.reversed ? (kb = p, tb = Ka) : kb = Ka)
            }
            var La = Math.round;
            this.pmx = La(ca);
            this.pmy = La(tb);
            ...
            for (L = P; L <= ia; L++) {
                ...
                if (m && void 0 == this.openField)
                    for (var yb = L + 1; yb < e.length && (!e[yb] || !(db = e[L + 1].axes[f.id].graphs[b]) || !db.values || (Ta = db.values.value, isNaN(Ta))); yb++);
                var S, R, K, ba, ja = NaN,
                    E = NaN,
                    F = NaN,
                    O = NaN,
                ...
                if (Ia) {
                    ...
                    m && (void 0 == this.openField ? db && (db.isNegative = Ta < W ? !0 : !1, isNaN(Ta) && (v.isNegative = !Sa)) : v.isNegative = Ta > W ? !0 : !1);
                    ...
                    switch (h) {
                        case "line":
                            if (isNaN(W)) z || (this.drawLineGraph(x, u, T, U), x = [], u = [], T = [], U = []);
                                ...
                                if (Math.abs(E - mb) >= ob || Math.abs(F - nb) >= ob) x.push(E), u.push(F), mb = E, nb = F;
                                ya = E;
                                Ea = F;
                                ka = E;
                                la = F;
                        ...
                        case "smoothedLine":
                            if (isNaN(W)) z || (this.drawSmoothedGraph(x, u, T, U), x = [], u = [], T = [], U = []);
                                ...
                                if (Math.abs(E -
                                        mb) >= ob || Math.abs(F - nb) >= ob) x.push(E), u.push(F), mb = E, nb = F;
                                ya = E;
                                Ea = F;
                                ka = E;
                                la = F;
                            ...
                            if (!isNaN(W)) {
                                ...
                                if (!(W < Qb && rb < Qb || W > Rb && rb > Rb)) {
                                    ...
                                    if (t) {
                                        ...
                                        K = d.roundTo(K, 2);
                                        ba = d.roundTo(ba, 2);
                                        R < q && 0 < K && (va = new d.Cuboid(g, ba, K, H - a.d3x, Q - a.d3y, Na, Wa, da, Ca, X, ga, w, t, ea, eb, pb, aa), v.columnWidth = Math.abs(ba), v.columnHeight = Math.abs(K))
                                    } else {
                                        ...
                                        K = d.roundTo(K, 2);
                                        ba = d.roundTo(ba, 2);
                                        S < n + Z * H && 0 < K && (this.showOnAxis && (R -= Q / 2), va = new d.Cuboid(g, K, ba, H - a.d3x, Q - a.d3y, Na, Wa, da, Ca, this.lineAlpha, ga, w, t, ea, eb, pb, aa), v.columnHeight = Math.abs(ba), v.columnWidth = Math.abs(K))
                                    }
                                }
                                if (va) {
                                    za = va.set;
                            ...
                            if (!isNaN(ua) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (R < q && 0 < K) {
                                        ...
                                        !isNaN(sa) && !isNaN(qa) && F < q && 0 < F && (Ya = d.line(g, Eb, [F, F], Ca, X, da), fb = d.line(g, Fb, [F, F], Ca, X, da));
                                        ba = E - O;
                                        va = new d.Cuboid(g, ba, K, H, Q, Na, bb, da, Ca, X, ga, w, t, ea, eb, pb, aa)
                                    }
                                } else {
                                    "open" == l && (la = N);
                                    "high" == l && (la = ta);
                                    ...
                                    if (S < n && 0 < K) {
                                        Bb && W >= ua && (Wa = 0);
                                        var va = new d.Cuboid(g, K, ba, H, Q, Na, Wa, da, Ca, X, ga, w, t, ea, eb, pb, aa),
                                            Gb, Hb;
                                        W > ua ? (Gb = [F, ta], Hb = [N, ra]) : (Gb = [N, ta], Hb = [F, ra]);
                                        !isNaN(ta) && !isNaN(ra) && E < n && 0 < E && (Ya = d.line(g, [E, E], Gb, Ca, X, da), fb = d.line(g, [E, E], Hb, Ca, X, da), d.setCN(a, Ya, this.bcn + "line-high"), v.className && d.setCN(a, Ya, v.className, !0), d.setCN(a, fb, this.bcn + "line-low"), v.className && d.setCN(a, fb, v.className, !0))
                                    }
                                }
                                va && (za = va.set, v.columnGraphics = za, fa.push(za), za.translate(S, R - da / 2), (v.url || this.showHandOnHover) && za.setAttr("cursor", "pointer"), Ya && (fa.push(Ya), fa.push(fb)), J || (v.x = t ? R + K / 2 : S + K / 2, this.animateColumns(va, L, E, O, F, N), this.addListeners(za, v), void 0 !== this.tabIndex && za.setAttr("tabindex", this.tabIndex)))
                            }
                            break;
                        case "ohlc":
                                ...
                                if (Zb) {
                                    ...
                                    if (Oa) {
                                        var $b = Oa.getBBox(),
                                            ac = $b.width,
                                            bc = $b.height,
                                            gb, hb, sb = f.totalTextOffset,
                                            cc = f.totals[L];
                                        cc && cc.remove();
                                        var ib = 0;
                                        "column" != h && (ib = this.bulletSize);
                                        t ? (hb = Ea, gb = 0 > W ? E - ac / 2 - 2 - ib - sb : E + ac / 2 + 3 + ib + sb) : (gb = ya, hb = 0 > W ? F + bc / 2 +
                                            ib + sb : F - bc / 2 - 3 - ib - sb);
                                        Oa.translate(gb, hb);
                                        f.totals[L] = Oa;
                                        t ? (0 > hb || hb > q) && Oa.remove() : (0 > gb || gb > n) && Oa.remove()
                                    }
                                }
                            }
                        }
        ...
        drawLineGraph: function (a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                void 0 === z || g.useNegativeColorIfDown || (p = d.line(l, a, b, z, r, p, x, !1, !0, f), p.node.setAttribute("stroke-linejoin", "round"), d.setCN(k, p, g.bcn + "stroke"), d.setCN(k, p, g.bcn + "stroke-negative"), n.push(p));
                if (0 < h || 0 < A)
